...
> Source: `src/content/docs/clients/next-js.mdx`
> Canonical URL: https://rivet.dev/docs/clients/next-js
> Description: The Rivet Next.js client allows you to connect to and interact with actors in Next.js applications.

---
- [View Example on GitHub](https://github.com/rivet-dev/rivet/tree/main/examples/next-js) — Check out the complete example

- [View the backend integration](https://rivet.dev/docs/integrations/next-js/) — Use Next.js API routes to run RivetKit Registry
...
_Source doc path: /docs/clients/next-js_
